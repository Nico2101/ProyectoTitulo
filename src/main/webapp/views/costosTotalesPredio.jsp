				...
				<div class="col-xs-12">
					<div class="box box-primary">
						<div class="box-header">
							<h3 class="box-title">Mostrar costos totales por predio</h3>
								...
								<div class="form-group">
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<label>* Temporada</label> <select id="temporadaSeleccionada"
											...
											onchange="SectoresDeUnaTemporada();">
											...
											una temporada</span> <span id="sinSectores" class="error"
											style="display: none">Temporada no tiene sectores</span>
									</div>
...
<script>
	function SectoresDeUnaTemporada() {
		...
		if (idTemporada > 0) {
			...
			$
					.ajax({
						type : 'POST',
						url : "obtenerSectoresDeUnaTemporada",
						dataType : 'json',
						data : {
						...
						success : function(data) {
							...
							if (!$.isEmptyObject(data)) {
								...
								document.getElementById('sinSectores').style.display = 'none';
								...
								document.getElementById('sinSectores').style.display = 'inline';
								$("#sectorSeleccionado").empty();
								$("#sectorSeleccionado")
										.append(
												'<option value="-1">Seleccione un sector</option>');
																		...
																		[
																				...
																				"$  "
																						+ currency(
																								...
																								1),
																				,
																				'<a href="#" onclick="verDetallesCostos('
																						+ data[i].idPredio
																						+ ');"><i class="fa fa-edit fa-lg" style="color: blue"></i></a>' ]
	...
	function verDetallesCostos(idPredio) {
		if (idPredio > 0) {
